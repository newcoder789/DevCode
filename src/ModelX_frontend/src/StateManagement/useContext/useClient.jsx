...
import { createActor } from "../../../../declarations/ModelX_backend/index";
...
const canisterID = process.env.CANISTER_ID_MODELX_BACKEND;
    ...
    useEffect(() => {
        if (agent) {
            const initActor = async () => {
                try {
                    const actor = createActor(process.env.CANISTER_ID_MODELX_BACKEND, { agent });
